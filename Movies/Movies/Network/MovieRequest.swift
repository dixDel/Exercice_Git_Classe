...
typealias ImageRequestCallback = (_ image: UIImage?, _ error: String?) -> Void
...
protocol MovieRequest {
  ...
  func getImage (_ imageView: UIImageView, url: String, size: Int, radius: Float, placeholderImageName: String) -> Void
}
